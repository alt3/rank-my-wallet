...
describe("Ensure bigToString:", function () {
  ...
  it("respects requested fractions for ERG", () => {
    ...
    const result = bigToString(balance, locale, 9)
